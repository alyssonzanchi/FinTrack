...
public class InvoiceTest {
    ...
    void testInvoiceCreationWithNullCreditCard() {
        Exception exception = assertThrows(MissingInvoiceFieldException.class, () ->
                new Invoice(null, LocalDate.of(2024, 12, 9), LocalDate.of(2024, 12, 19), LocalDate.of(2024, 12, 30)));
    ...
    void testInvoiceCreationWithNullDates() {
        Exception exception = assertThrows(MissingInvoiceFieldException.class, () ->
                new Invoice(creditCard, null, LocalDate.of(2024, 12, 19), LocalDate.of(2024, 12, 30)));
    ...
    void testInvoiceCreationWithNullEndDate() {
        Exception exception = assertThrows(MissingInvoiceFieldException.class, () ->
                new Invoice(creditCard, LocalDate.of(2024, 12, 9), null, LocalDate.of(2024, 12, 30)));
    ...
    void testInvoiceCreationWithNullDueDate() {
        Exception exception = assertThrows(MissingInvoiceFieldException.class, () ->
                new Invoice(creditCard, LocalDate.of(2024, 12, 9), LocalDate.of(2024, 12, 19), null));
    ...
    void testInvoiceCreationWithEndDateBeforeStartDate() {
        Exception exception = assertThrows(InvalidInvoiceDataException.class, () ->
                new Invoice(creditCard, LocalDate.of(2024, 12, 19), LocalDate.of(2024, 12, 9), LocalDate.of(2024, 12, 30)));
